        ...
        for idx, row in df_raw.iterrows():
            ...
            if col0 in ['insumo', 'composição auxiliar', 'composicao auxiliar', 'item', 'composição', 'composicao']:
                ...
                if col_cod < len(row_list):
                    ...
                    # 1. CALCULAR QTD, UND E PRECO PARA TODOS OS ITENS (PAI OU FILHO)
                    if is_sicro_section:
                    ...
                    # 2. DEFINIR QUEM É O PAI DESSA LINHA
                    ...
                    # 3. ADICIONAR NA LISTA (ISSO GARANTE QUE A COMPOSIÇÃO PAI TAMBÉM SEJA AUDITADA)
                    ordem_sequencial += 1
                    dados.append({
                    ...
                    # 4. SE FOR COMPOSIÇÃO, ATUALIZAR O PAI PARA AS PRÓXIMAS LINHAS
